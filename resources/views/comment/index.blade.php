...
<table class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="student/{{$co->id}}"><button class="btn btn-info">Xem</button></a>
                <a href="{{route('student.edit',$co->id)}}"><button class="btn btn-success">Sửa</button></a>
            </td>
            <td>
                <form action="{{route('students.destroy',$co->id)}}" method="post">
                    @csrf
                    <input type="hidden" name="_method" value="DELETE"></input>
                    <button class="btn btn-danger" type="submit">Xóa</button> <a href="student/{{$co->id}}"></a>
                </form>
            </td>
        </tr>
        @endforeach
